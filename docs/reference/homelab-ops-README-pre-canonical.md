...
The tradeoff is tmpfs isn't persistent. A power failure can lose any database
changes made since the last disk backup. Make sure you understand and accept
these risks before using it!
...
These scripts are provided as-is. Verify your configuration and keep current
backups before using them with live data.
